	...
	public void onPublish(PublishMsg msg) {
		...
		if (subscribers != null && !subscribers.isEmpty()) {
			for (String subscriber : subscribers) {
				...
				if (session != null) {
					Logger.log("Sending publish message to subscriber: " + subscriber);
					session.send(msg);
				} else {
					Logger.log("No session for subscriber: " + subscriber);
				}
			}
		} else {
			Logger.log("No subscriber found for topic: " + msg.getTopic());
		}
	}
}
